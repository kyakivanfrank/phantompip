    ...
    return successResponse(
      {
        user: {
          ...
          subscription: {
            ...
            planName: isSubscriptionActive ? user.subscription.planName : "No Plan",
            billingCycle: user.subscription.billingCycle,
            expiryDate: isSubscriptionActive ? user.subscription.expiryDate : "",
            expiryTimestamp: isSubscriptionActive ? expiryTimestamp : 0,
            remainingDays,
            paidAmount: isSubscriptionActive ? latestConfirmedPayment?.amount ?? user.subscription.priceUSD ?? 0 : 0,
